; ModuleID = '/home/albasg/Documentos/semestre-2/pd/project/GPU4S_Bench/gpu4s_benchmark/relu_bench/cpu_functions/proj_relu/fsolution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline willreturn
define void @apatb_relu_ir(double* noalias nocapture nonnull readonly %A, double* noalias nocapture nonnull %B, i32 %size) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_relu_hw(double* %A_copy, double* %B_copy, i32 %size)
...
declare void @apatb_relu_hw(double*, double*, i32)
...
declare void @relu_hw_stub(double* noalias nocapture nonnull readonly, double* noalias nocapture nonnull, i32)

define void @relu_hw_stub_wrapper(double*, double*, i32) #4 {
entry:
  call void @copy_out(double* null, double* %0, double* null, double* %1)
  call void @relu_hw_stub(double* %0, double* %1, i32 %2)
