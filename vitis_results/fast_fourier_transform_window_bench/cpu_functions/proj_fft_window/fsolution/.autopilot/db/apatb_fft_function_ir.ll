; ModuleID = '/home/albasg/Documentos/semestre-2/pd/project/GPU4S_Bench/gpu4s_benchmark/fast_fourier_transform_window_bench/cpu_functions/proj_fft_window/fsolution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline willreturn
define void @apatb_fft_function_ir(float* noalias nocapture nonnull readonly %data, float* noalias nocapture nonnull %output, i64 %window, i64 %nn) local_unnamed_addr #0 {
entry:
  %data_copy = alloca float, align 512
  %output_copy = alloca float, align 512
  call fastcc void @copy_in(float* nonnull %data, float* nonnull align 512 %data_copy, float* nonnull %output, float* nonnull align 512 %output_copy)
  call void @apatb_fft_function_hw(float* %data_copy, float* %output_copy, i64 %window, i64 %nn)
  call void @copy_back(float* %data, float* %data_copy, float* %output, float* %output_copy)
  ret void
}
...
declare void @apatb_fft_function_hw(float*, float*, i64, i64)
...
declare void @fft_function_hw_stub(float* noalias nocapture nonnull readonly, float* noalias nocapture nonnull, i64, i64)

define void @fft_function_hw_stub_wrapper(float*, float*, i64, i64) #4 {
entry:
  call void @copy_out(float* null, float* %0, float* null, float* %1)
  call void @fft_function_hw_stub(float* %0, float* %1, i64 %2, i64 %3)
