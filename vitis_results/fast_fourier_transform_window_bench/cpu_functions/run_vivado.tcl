create_project vivado_fft_window ./vivado_fft_window -part xc7z020clg484-1 -force
file mkdir vivado_reports
foreach ip_tcl [glob ./proj_fft_window/fsolution/syn/verilog/*_ip.tcl] {
    source $ip_tcl
}
read_verilog [glob ./proj_fft_window/fsolution/syn/verilog/*.v]
