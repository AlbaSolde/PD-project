...
// tvout file define:
#define AUTOTB_TVOUT_PC_data "../tv/rtldatafile/rtl.fft_function.autotvout_data.dat"
...
extern "C"
void fft_function_hw_stub_wrapper(void*, hls::sim::Byte<8>);

extern "C"
void apatb_fft_function_hw(void* __xlx_apatb_param_data, hls::sim::Byte<8> __xlx_apatb_param_nn)
{
  ...
  port1.param = &__xlx_apatb_param_nn;
  ...
  try {
    ...
    fft_function_hw_stub_wrapper(__xlx_apatb_param_data, __xlx_apatb_param_nn);
