set moduleName fft_function_Pipeline_VITIS_LOOP_18_2
set isTopModule 0
...
set cdfgNum 12
set C_modelName {fft_function_Pipeline_VITIS_LOOP_18_2}
...
set C_modelArgList {
	...
	{ m_out int 64 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "j", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "m_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ m_out sc_out sc_lv 64 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "m_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	m_out { ap_vld {  { m_out out_data 1 64 }  { m_out_ap_vld out_vld 1 1 } } }
}
