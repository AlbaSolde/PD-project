...
(* CORE_GENERATION_INFO="lrn_lrn,hls_ip_2025_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=9.660000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.978000,HLS_SYN_LAT=256,HLS_SYN_TPT=none,HLS_SYN_MEM=30,HLS_SYN_DSP=0,HLS_SYN_FF=17164,HLS_SYN_LUT=16237,HLS_VERSION=2025_2}" *)
...
wire   [63:0] grp_pow_generic_double_s_fu_79_ap_return;
reg   [63:0] reg_132;
wire    ap_CS_fsm_state91;
wire    ap_CS_fsm_state196;
wire   [63:0] grp_fu_114_p1;
reg   [63:0] conv_reg_159;
wire    ap_CS_fsm_state2;
wire   [63:0] grp_fu_123_p2;
reg   [63:0] mul_reg_165;
wire    ap_CS_fsm_state98;
wire   [63:0] grp_fu_118_p2;
reg   [63:0] add_reg_170;
wire    ap_CS_fsm_state106;
wire   [63:0] grp_fu_128_p2;
reg   [63:0] div_reg_175;
wire    ap_CS_fsm_state255;
reg   [63:0] grp_pow_generic_double_s_fu_79_base_r;
reg   [63:0] grp_pow_generic_double_s_fu_79_exp;
reg    grp_pow_generic_double_s_fu_79_ap_ce;
...
lrn_pow_generic_double_s grp_pow_generic_double_s_fu_79(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .base_r(grp_pow_generic_double_s_fu_79_base_r),
    .exp(grp_pow_generic_double_s_fu_79_exp),
    .ap_return(grp_pow_generic_double_s_fu_79_ap_return),
    .ap_ce(grp_pow_generic_double_s_fu_79_ap_ce)
);

lrn_fptrunc_64ns_32_2_no_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 64 ),
    .dout_WIDTH( 32 ))
fptrunc_64ns_32_2_no_dsp_1_U54(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(div_reg_175),
    .ce(1'b1),
...
lrn_dadd_64ns_64ns_64_8_full_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 8 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dadd_64ns_64ns_64_8_full_dsp_1_U56(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(mul_reg_165),
...
lrn_dmul_64ns_64ns_64_7_max_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 7 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
...
dmul_64ns_64ns_64_7_max_dsp_1_U57(
    ...
    .reset(ap_rst),
    .din0(reg_132),
    .din1(64'd4562254509136412672),
    .ce(1'b1),
    .dout(grp_fu_123_p2)
);

lrn_ddiv_64ns_64ns_64_59_no_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 59 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
ddiv_64ns_64ns_64_59_no_dsp_1_U58(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(conv_reg_159),
    .din1(reg_132),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state106)) begin
        add_reg_170 <= grp_fu_118_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        conv_reg_159 <= grp_fu_114_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state255)) begin
        div_reg_175 <= grp_fu_128_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state98)) begin
        mul_reg_165 <= grp_fu_123_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state196) | (1'b1 == ap_CS_fsm_state91))) begin
        reg_132 <= grp_pow_generic_double_s_fu_79_ap_return;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state257) & (icmp_ln47_fu_143_p2 == 1'd0))) begin
        B_ap_vld = 1'b1;
    end else begin
        B_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state255) | (1'b1 == ap_CS_fsm_state106) | (1'b1 == ap_CS_fsm_state98) | (1'b1 == ap_CS_fsm_state1) | (1'b1 == ap_CS_fsm_state257) | (1'b1 == ap_CS_fsm_state256) | (1'b1 == ap_CS_fsm_state254) | (1'b1 == ap_CS_fsm_state253) | (1'b1 == ap_CS_fsm_state252) | (1'b1 == ap_CS_fsm_state251) | (1'b1 == ap_CS_fsm_state250) | (1'b1 == ap_CS_fsm_state249) | (1'b1 == ap_CS_fsm_state248) | (1'b1 == ap_CS_fsm_state247) | (1'b1 == ap_CS_fsm_state246) | (1'b1 == ap_CS_fsm_state245) | (1'b1 == ap_CS_fsm_state244) | (1'b1 == ap_CS_fsm_state243) | (1'b1 == ap_CS_fsm_state242) | (1'b1 == ap_CS_fsm_state241) | (1'b1 == ap_CS_fsm_state240) | (1'b1 == ap_CS_fsm_state239) | (1'b1 == ap_CS_fsm_state238) | (1'b1 == ap_CS_fsm_state237) | (1'b1 == ap_CS_fsm_state236) | (1'b1 == ap_CS_fsm_state235) | (1'b1 == ap_CS_fsm_state234) | (1'b1 == ap_CS_fsm_state233) | (1'b1 == ap_CS_fsm_state232) | (1'b1 == ap_CS_fsm_state231) | (1'b1 == ap_CS_fsm_state230) | (1'b1 == ap_CS_fsm_state229) | (1'b1 == ap_CS_fsm_state228) | (1'b1 
    == ap_CS_fsm_state227) | (1'b1 == ap_CS_fsm_state226) | (1'b1 == ap_CS_fsm_state225) | (1'b1 == ap_CS_fsm_state224) | (1'b1 == ap_CS_fsm_state223) | (1'b1 == ap_CS_fsm_state222) | (1'b1 == ap_CS_fsm_state221) | (1'b1 == ap_CS_fsm_state220) | (1'b1 == ap_CS_fsm_state219) | (1'b1 == ap_CS_fsm_state218) | (1'b1 == ap_CS_fsm_state217) | (1'b1 == ap_CS_fsm_state216) | (1'b1 == ap_CS_fsm_state215) | (1'b1 == ap_CS_fsm_state214) | (1'b1 == ap_CS_fsm_state213) | (1'b1 == ap_CS_fsm_state212) | (1'b1 == ap_CS_fsm_state211) | (1'b1 == ap_CS_fsm_state210) | (1'b1 == ap_CS_fsm_state209) | (1'b1 == ap_CS_fsm_state208) | (1'b1 == ap_CS_fsm_state207) | (1'b1 == ap_CS_fsm_state206) | (1'b1 == ap_CS_fsm_state205) | (1'b1 == ap_CS_fsm_state204) | (1'b1 == ap_CS_fsm_state203) | (1'b1 == ap_CS_fsm_state202) | (1'b1 == ap_CS_fsm_state201) | (1'b1 == ap_CS_fsm_state200) | (1'b1 == ap_CS_fsm_state199) | (1'b1 == ap_CS_fsm_state198) | (1'b1 == ap_CS_fsm_state197) | (1'b1 == ap_CS_fsm_state105) | (1'b1 == ap_CS_fsm_state104) | (1'b1 == 
    ap_CS_fsm_state103) | (1'b1 == ap_CS_fsm_state102) | (1'b1 == ap_CS_fsm_state101) | (1'b1 == ap_CS_fsm_state100) | (1'b1 == ap_CS_fsm_state99) | (1'b1 == ap_CS_fsm_state97) | (1'b1 == ap_CS_fsm_state96) | (1'b1 == ap_CS_fsm_state95) | (1'b1 == ap_CS_fsm_state94) | (1'b1 == ap_CS_fsm_state93) | (1'b1 == ap_CS_fsm_state92))) begin
        grp_pow_generic_double_s_fu_79_ap_ce = 1'b0;
    end else begin
        grp_pow_generic_double_s_fu_79_ap_ce = 1'b1;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state107)) begin
        grp_pow_generic_double_s_fu_79_base_r = add_reg_170;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        grp_pow_generic_double_s_fu_79_base_r = grp_fu_114_p1;
    end else begin
        grp_pow_generic_double_s_fu_79_base_r = 'bx;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state107)) begin
        grp_pow_generic_double_s_fu_79_exp = 64'd4604930618986332160;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        grp_pow_generic_double_s_fu_79_exp = 64'd4611686018427387904;
    end else begin
        grp_pow_generic_double_s_fu_79_exp = 'bx;
    end
end
...
assign grp_fu_114_p0 = A;

assign icmp_ln47_fu_143_p2 = ((size == 32'd0) ? 1'b1 : 1'b0);
