...
attribute shreg_extract : string;
    ...
    signal icmp_ln56_fu_78_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal div1_fu_32 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal grp_fu_92_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_allocacmp_div1_load_1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal add_ln56_fu_83_p2 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component softmax_sdiv_32ns_32ns_32_36_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    sdiv_32ns_32ns_32_36_1_U1 : component softmax_sdiv_32ns_32ns_32_36_1
    generic map (
        ID => 1,
        NUM_STAGE => 36,
        din0_WIDTH => 32,
    ...
    div1_fu_32_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    add_ln56_fu_83_p2 <= std_logic_vector(unsigned(indvar_flatten_fu_36) + unsigned(ap_const_lv64_1));
    ...
    ap_condition_exit_pp0_iter0_stage1_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_subdone, ap_enable_reg_pp0_iter0_reg, icmp_ln56_fu_78_p2)
    begin
        if (((icmp_ln56_fu_78_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0_reg = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_subdone) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    ap_ready_int_assign_proc : process(ap_enable_reg_pp0_iter0_reg, ap_CS_fsm_pp0_stage34, ap_block_pp0_stage34_subdone)
    begin
    ...
    ap_sig_allocacmp_div1_load_1_assign_proc : process(ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage1, div1_fu_32, grp_fu_92_p2, ap_block_pp0_stage1)
    begin
    ...
    div1_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln56_fu_78_p2, ap_loop_exit_ready, ap_block_pp0_stage1_11001)
    begin
        if (((ap_loop_exit_ready = ap_const_logic_1) and (icmp_ln56_fu_78_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            div1_out_ap_vld <= ap_const_logic_1;
        else 
            div1_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    icmp_ln56_fu_78_p2 <= "1" when (indvar_flatten_fu_36 = mul_ln42) else "0";
end behav;
