; ModuleID = '/home/albasg/Documentos/semestre-2/pd/project/GPU4S_Bench/gpu4s_benchmark/softmax_bench/cpu_functions/proj_softmax/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline willreturn
define void @apatb_softmax_ir(float* noalias nocapture nonnull readonly %A, float* noalias nocapture nonnull %B, i32 %size) local_unnamed_addr #0 {
entry:
  %A_copy = alloca float, align 512
  %B_copy = alloca float, align 512
  call fastcc void @copy_in(float* nonnull %A, float* nonnull align 512 %A_copy, float* nonnull %B, float* nonnull align 512 %B_copy)
  call void @apatb_softmax_hw(float* %A_copy, float* %B_copy, i32 %size)
  call void @copy_back(float* %A, float* %A_copy, float* %B, float* %B_copy)
  ret void
}
...
declare void @apatb_softmax_hw(float*, float*, i32)
...
declare void @softmax_hw_stub(float* noalias nocapture nonnull readonly, float* noalias nocapture nonnull, i32)

define void @softmax_hw_stub_wrapper(float*, float*, i32) #4 {
entry:
  call void @copy_out(float* null, float* %0, float* null, float* %1)
  call void @softmax_hw_stub(float* %0, float* %1, i32 %2)
