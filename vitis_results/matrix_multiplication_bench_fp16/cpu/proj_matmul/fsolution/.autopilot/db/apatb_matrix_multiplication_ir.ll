; ModuleID = '/home/albasg/Documentos/semestre-2/pd/project/GPU4S_Bench/gpu4s_benchmark/matrix_multiplication_bench_fp16/cpu/proj_matmul/fsolution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline willreturn
define void @apatb_matrix_multiplication_ir(float* noalias nocapture nonnull readonly %A, float* noalias nocapture nonnull readonly %B, float* noalias nocapture nonnull %C, i32 %n, i32 %m, i32 %w) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_matrix_multiplication_hw(float* %A_copy, float* %B_copy, float* %C_copy, i32 %n, i32 %m, i32 %w)
...
declare void @apatb_matrix_multiplication_hw(float*, float*, float*, i32, i32, i32)
...
declare void @matrix_multiplication_hw_stub(float* noalias nocapture nonnull readonly, float* noalias nocapture nonnull readonly, float* noalias nocapture nonnull, i32, i32, i32)

define void @matrix_multiplication_hw_stub_wrapper(float*, float*, float*, i32, i32, i32) #4 {
entry:
  call void @copy_out(float* null, float* %0, float* null, float* %1, float* null, float* %2)
  call void @matrix_multiplication_hw_stub(float* %0, float* %1, float* %2, i32 %3, i32 %4, i32 %5)
