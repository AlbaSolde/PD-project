; ModuleID = '/home/albasg/Documentos/semestre-2/pd/project/GPU4S_Bench/gpu4s_benchmark/cifar_10_multiple/cpu_functions/proj_cifar10_multiple/fsolution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline willreturn
define void @apatb_cifar10_ir(float* noalias nocapture nonnull %output_data, float* noalias nocapture nonnull %conv_1_output, float* noalias nocapture nonnull %pooling_1_output, float* noalias nocapture nonnull %conv_2_output, float* noalias nocapture nonnull %pooling_2_output, float* noalias nocapture nonnull %dense_layer_1_output, float* noalias nocapture nonnull %dense_layer_2_output, float* noalias nocapture nonnull readonly %input_data, float* noalias nocapture nonnull readonly %kernel_1_data, float* noalias nocapture nonnull readonly %kernel_2_data, float* noalias nocapture nonnull readonly %weights_1, float* noalias nocapture nonnull readonly %weights_2, i32 %input_data_size, i32 %output_data_size, i32 %kernel_1_size, i32 %kernel_2_size, i32 %stride_1_size, i32 %stride_2_size, i32 %neurons_dense_1_size, i32 %neurons_dense_2_size, i32 %number_of_images) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_cifar10_hw(float* %output_data_copy, float* %conv_1_output_copy, float* %pooling_1_output_copy, float* %conv_2_output_copy, float* %pooling_2_output_copy, float* %dense_layer_1_output_copy, float* %dense_layer_2_output_copy, float* %input_data_copy, float* %kernel_1_data_copy, float* %kernel_2_data_copy, float* %weights_1_copy, float* %weights_2_copy, i32 %input_data_size, i32 %output_data_size, i32 %kernel_1_size, i32 %kernel_2_size, i32 %stride_1_size, i32 %stride_2_size, i32 %neurons_dense_1_size, i32 %neurons_dense_2_size, i32 %number_of_images)
...
declare void @apatb_cifar10_hw(float*, float*, float*, float*, float*, float*, float*, float*, float*, float*, float*, float*, i32, i32, i32, i32, i32, i32, i32, i32, i32)
...
declare void @cifar10_hw_stub(float* noalias nocapture nonnull, float* noalias nocapture nonnull, float* noalias nocapture nonnull, float* noalias nocapture nonnull, float* noalias nocapture nonnull, float* noalias nocapture nonnull, float* noalias nocapture nonnull, float* noalias nocapture nonnull readonly, float* noalias nocapture nonnull readonly, float* noalias nocapture nonnull readonly, float* noalias nocapture nonnull readonly, float* noalias nocapture nonnull readonly, i32, i32, i32, i32, i32, i32, i32, i32, i32)

define void @cifar10_hw_stub_wrapper(float*, float*, float*, float*, float*, float*, float*, float*, float*, float*, float*, float*, i32, i32, i32, i32, i32, i32, i32, i32, i32) #4 {
entry:
  ...
  call void @cifar10_hw_stub(float* %0, float* %1, float* %2, float* %3, float* %4, float* %5, float* %6, float* %7, float* %8, float* %9, float* %10, float* %11, i32 %12, i32 %13, i32 %14, i32 %15, i32 %16, i32 %17, i32 %18, i32 %19, i32 %20)
