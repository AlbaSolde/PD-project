; ModuleID = '/home/albasg/Documentos/semestre-2/pd/project/GPU4S_Bench/gpu4s_benchmark/max_pooling_bench/cpu_functions/proj_maxpool/fsolution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline willreturn
define void @apatb_max_pooling_ir(double* noalias nocapture nonnull readonly %A, double* noalias nocapture nonnull %B, i32 %size, i32 %stride, i32 %lateral_stride) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_max_pooling_hw(double* %A_copy, double* %B_copy, i32 %size, i32 %stride, i32 %lateral_stride)
...
declare void @apatb_max_pooling_hw(double*, double*, i32, i32, i32)
...
declare void @max_pooling_hw_stub(double* noalias nocapture nonnull readonly, double* noalias nocapture nonnull, i32, i32, i32)

define void @max_pooling_hw_stub_wrapper(double*, double*, i32, i32, i32) #4 {
entry:
  call void @copy_out(double* null, double* %0, double* null, double* %1)
  call void @max_pooling_hw_stub(double* %0, double* %1, i32 %2, i32 %3, i32 %4)
