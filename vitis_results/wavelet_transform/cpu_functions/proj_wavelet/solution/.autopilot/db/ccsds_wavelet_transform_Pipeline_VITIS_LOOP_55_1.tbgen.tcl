set moduleName ccsds_wavelet_transform_Pipeline_VITIS_LOOP_55_1
set isTopModule 0
...
set cdfgNum 4
set C_modelName {ccsds_wavelet_transform_Pipeline_VITIS_LOOP_55_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 64, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "B","offset": { "type": "dynamic","port_name": "B","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "A","offset": { "type": "dynamic","port_name": "A","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "size", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "add_ln65", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_axi_gmem0_0_WDATA sc_out sc_lv 64 signal 1 } 
	{ m_axi_gmem0_0_WSTRB sc_out sc_lv 8 signal 1 } 
	...
	{ m_axi_gmem0_0_RDATA sc_in sc_lv 64 signal 1 } 
	...
	{ m_axi_gmem1_0_WDATA sc_out sc_lv 64 signal 0 } 
	{ m_axi_gmem1_0_WSTRB sc_out sc_lv 8 signal 0 } 
	...
	{ m_axi_gmem1_0_RDATA sc_in sc_lv 64 signal 0 } 
	...
	{ add_ln65 sc_in sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln65", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "add_ln65", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	add_ln65 { ap_none {  { add_ln65 in_data 0 32 } } }
