set moduleName vector_convolution
set isTopModule 1
...
set cdfgNum 4
set C_modelName {vector_convolution}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ A int 32 regular {pointer 0}  }
	{ kernel int 32 regular {pointer 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "kernel", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ kernel sc_in sc_lv 32 signal 1 } 
	{ B_i sc_in sc_lv 32 signal 2 } 
	{ B_o sc_out sc_lv 32 signal 2 } 
	{ B_o_ap_vld sc_out sc_logic 1 outvld 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "kernel", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "kernel", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	kernel { ap_none {  { kernel in_data 0 32 } } }
