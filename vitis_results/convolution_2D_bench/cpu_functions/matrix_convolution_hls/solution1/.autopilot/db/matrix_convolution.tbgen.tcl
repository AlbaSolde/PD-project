set moduleName matrix_convolution
set isTopModule 1
...
set cdfgNum 4
set C_modelName {matrix_convolution}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ A int 64 regular {pointer 0}  }
	{ kernel int 64 regular {pointer 0}  }
...
set portList { 
	...
	{ kernel sc_in sc_lv 64 signal 1 } 
	{ B sc_out sc_lv 64 signal 2 } 
...
set ArgLastReadFirstWriteLatency {
	matrix_convolution {
		...
		kernel {Type I LastRead 18 FirstWrite -1}
		B {Type O LastRead -1 FirstWrite 20}
		size {Type I LastRead 8 FirstWrite -1}
